...
S32 m_lAlphaChannelInterval;           // Show each alpha for this amount of time
S32 m_lTimeToLive;                     // Total time to show this animation
S32 m_lTotalFlameTime;                 // Total time to show the flame (non adjusted for game time)
...
short Setup(                                          // Returns 0 on success.
   ...
   S32 lTimeToLive,                                   // In: Milliseconds to burn
