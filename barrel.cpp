...
S32 CBarrel::ms_lExplosionWait = 0;       // Time to wait after explosion before fire
S32 CBarrel::ms_lExplosionDelay = 150;    // Delay before explosion is set off by another
