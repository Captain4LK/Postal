...
static S32 ms_lReseekTime;          // Do a 'find' again
static S32 ms_lWatchWaitTime;       // Time to watch shot go
static S32 ms_lReselectDudeTime;      // Time to go without finding a dude
                                      // before calling SelectDude() to find
                                      // possibly a closer one.
static S32 ms_lMinCommentTime;         // Min time before making a random comment
static S32 ms_lCommentTimeVariance;      // Random amount added on to comment timer.
