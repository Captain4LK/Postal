...
typedef enum
{
   ...
   // quite possible that S32 after we went past a particular frame, we might get a very old
   ...
   //
   // The range of sequence numbers should be determined based on how S32 an "old" message
