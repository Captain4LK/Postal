...
///////////////////////////////////////////////////////////////////////////////
S32 Put(                // Returns 1 if it fit, 0 if not enough room in queue
...
S32 Put(                // Returns number of items that were put into queue
   ...
   S32 lNum)               // In:  Number of bytes to put.
{
...
S32 Put(                // Returns number of items that were put into queue
   ...
   S32 lNum = 1)           // In:  Number of S16s to put.
{
...
///////////////////////////////////////////////////////////////////////////////
S32 Get(                // Returns 1 if item was dequeued, 0 otherwise
...
S32 Get(                // Returns number of items dequeued.
   ...
   S32 lNum = 1)           // In:  Number of bytes to get.
{
...
S32 Get(                // Returns number of items dequeued.
   ...
   S32 lNum = 1)           // In:  Number of S16s to get.
{
...
void LockPutPtr(
   ...
   S32* plAvail)                 // Out: Number of bytes that can be put to above pointer
{
...
///////////////////////////////////////////////////////////////////////////////
void ReleasePutPtr(
   S32 lBytes)                   // In:  Number of bytes written to locked pointer
{
...
void LockGetPtr(
   ...
   S32* plAvail)                 // Out: Number of bytes that can be gotten from above pointer
{
...
///////////////////////////////////////////////////////////////////////////////
void ReleaseGetPtr(
   S32 lBytes)                   // In:  Number of bytes that were gotten from locked pointer
{
