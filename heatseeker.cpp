...
S32 CHeatseeker::ms_lArmingTime = 500;             // Time before weapon arms.
S32 CHeatseeker::ms_lSeekRadius = 150;                // Radius of heatseeking circle
...
S32 CHeatseeker::ms_lSmokeTrailInterval = 10;         // MS between smoke releases
S32 CHeatseeker::ms_lSmokeTimeToLive = 1000;       // MS for smoke to stay around.
