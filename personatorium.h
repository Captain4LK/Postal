...
//                     since it takes them S32er to shoot.
//
...
public:
   ...
   // Stats.
   S32 lGuardTimeout;                        // Interval between checking for intruders
   S32 lRunShootInterval;                    // Delay between shots while running
   S32 lShotTimeout;                      // Time to wait before reacting to next shot.
