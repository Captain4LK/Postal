...
S32 m_lNextSmokeTime;                                 // Time of dispersion of next smoke.
...
static S32 ms_lGrenadeFuseTime;                       // Time from throw to blow
static S32 ms_lSmokeInterval;                      // Time between smokes.
