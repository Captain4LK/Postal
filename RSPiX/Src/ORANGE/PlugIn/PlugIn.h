...
DLL2EXE virtual S32   GetDllMagicSize(void);
...
S32 m_lMagicSize;                         // The size of this structure.
...
typedef S32 (GETDLLMAGICSIZE)(CPlugIn*);
...
inline S32   GetMagicSize(void) { return sizeof(CPlugIn); }
