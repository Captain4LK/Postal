...
S32 m_lAbsX;         // Absolute X position
S32 m_lAbsY;         // Absolute Y position
S32 m_lAbsZ;         // Absolute Z position
...
RCircularRegion(S32 lX, S32 lY, S32 lR);
RCircularRegion(S32 lX, S32 lY,
                S32 lXCirc, S32 lYCirc,
                S32 lRadius);
...
RSphericalRegion(S32 lX, S32 lY, S32 lZ, S32 lR);
RSphericalRegion(S32 lX, S32 lY, S32 lZ,
...
RRectangularRegion(S32 lX, S32 lY,
...
RCubicRegion(S32 lX, S32 lY, S32 lLeft, S32 lRight,
             S32 lTop, S32 lBottom, S32 lFront, S32 lBack);
RCubicRegion(S32 lX, S32 lY, S32 lZ, S32 lLeft, S32 lRight,
             S32 lTop, S32 lBottom, S32 lFront, S32 lBack);
