...
NOTE: Some functions can take a S32 AS an frS16.  Understand that this is
a memory cast as a frS16 and does NOT represent the actual S32 "value"!
...
inline void rspfrSet(RFracS16& fr, S32 lVal) { fr.set = lVal; }
...
//
inline void rspfrAdd32(S32 &lVal, S32 &lNum, S32 &lDel, S32 &lInc,
                       S32 &lDen, S32 &lAdd, PROPER, POSITIVE)
{
   lNum += lInc;
...
//
inline void rspfrAdd32(S32 &lVal, S32 &lNum, S32 &lDel, S32 &lInc,
                       S32 &lDen, S32 &lAdd, IMPROPER, POSITIVE)
{
   lVal += lDel;
   lNum += lInc;
   if (lNum >= lDen) { lNum -= lDen; lVal += lAdd; }
...
//
inline void rspfrAdd32(S32 &lVal, S32 &lNum, S32 &lDel, S32 &lInc,
                       S32 &lDen, S32 &lAdd, PROPER, NEGATIVE)
{
   lNum += lInc;
...
//
inline void rspfrAdd32(S32 &lVal, S32 &lNum, S32 &lDel, S32 &lInc,
                       S32 &lDen, S32 &lAdd, IMPROPER, NEGATIVE)
{
   lVal += lDel;
   lNum += lInc;
   if (lNum < 0) { lNum += lDen; lVal -= lAdd; }
