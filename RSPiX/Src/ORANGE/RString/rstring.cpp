...
// S32, then the requested length is clipped, and only 5 characters are
// returned.
//
...
////////////////////////////////////////////////////////////////////////////////
void RString::Grow(S32 lMinimumSize)
{
...
////////////////////////////////////////////////////////////////////////////////
void RString::Shrink(S32 lMaximumSize)
{
...
////////////////////////////////////////////////////////////////////////////////
S32 RString::Format(S32 lMinimumSize, char* format, ...)
{
   S32 lWritten = 0;
   if (lMinimumSize >= 0)
   {
...
////////////////////////////////////////////////////////////////////////////////
RString RString::Left(S32 lLen) const
{
   RString str;
...
// string's length will be lLen or this string's length, whichever is less.
////////////////////////////////////////////////////////////////////////////////
RString RString::Right(S32 lLen) const
{
   RString str;
   if ((lLen > 0) && (m_lStrLen > 0))
   {
...
// of this string.
////////////////////////////////////////////////////////////////////////////////
RString RString::Mid(S32 lPos, S32 lLen) const
{
   RString str;
...
////////////////////////////////////////////////////////////////////////////////
RString RString::Range(S32 lPos1, S32 lPos2) const
{
   RString str;
...
// will do nothing.
////////////////////////////////////////////////////////////////////////////////
void RString::Insert(S32 lPos, const RString& str)
{
...
void RString::Insert(S32 lPos, const char* psz)
{
   S32 lLen = strlen(psz);
...
void RString::Insert(S32 lPos, char c)
{
...
////////////////////////////////////////////////////////////////////////////////
void RString::Delete(S32 lPos, S32 lLen)
{
   if ((lPos >= 0) && (lPos < m_lStrLen) && (lLen > 0)) // implies m_lStrLen > 0
   {
      if ((lPos + lLen) > m_lStrLen)
