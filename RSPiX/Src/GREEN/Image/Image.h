...
short CreatePalette(U32 ulSize);
...
typedef short (*LOADFUNC)(RImage* pImage, RFile* pcf /*, U32 ulVersion*/);
// Save extension for special types - saves m_pSpecial data
typedef short (*SAVEFUNC)(RImage* pImage, RFile* pcf /*, U32 ulVersion*/);
