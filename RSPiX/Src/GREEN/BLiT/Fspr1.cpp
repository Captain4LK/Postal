...
NEXT_Y:
   ...
   *pCode++ = 255;
   ...
   //****************** SHRINK THE BUFFER!
   S32 lCompressedSize = pCode - pCodeBuf + 1;
   S32 lAlignSize = (lCompressedSize + 15) & ~15;
   ...
   if (S32(pCode - pCodeBuf + 1) > lMaxSize)
   {
   ...
   pimNew->m_lPitch = (S32)pimNew->m_sWidth; // Pitch is meaningless here!
