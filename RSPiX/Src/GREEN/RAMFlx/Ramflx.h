...
typedef struct tag_FLX_FILE_HDR
{
   ...
   S32 lMilliPerFrame;           // FLC: milliseconds between frames (4 bytes)
...
// Returns 0 if successfull, non-zero otherwise.
short CreateBuf(CImage* pimage, S32 lWidth, S32 lHeight, short sColors);
...
short AllocBuf(CImage* pbuf, S32 lWidth, S32 lHeight, short sColors);
