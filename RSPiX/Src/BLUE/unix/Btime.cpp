...
// Returns the time in a S32.
//
//////////////////////////////////////////////////////////////////////////////
extern S32 rspGetMilliseconds(void)
{
   return (S32) (SDL_GetTicks());
}
...
//
//////////////////////////////////////////////////////////////////////////////
extern S32 rspGetMicroseconds(   // Returns microseconds between now and
                                 // last
                                 ...
                                 // just over 35 minutes.
{
   ...
   S32 lTime = (S32) (microsecs - MicrosecondsBase);
