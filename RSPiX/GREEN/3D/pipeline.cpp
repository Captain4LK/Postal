...
S32 RPipeLine::ms_lNumPts = 0;
S32 RPipeLine::ms_lNumPipes = 0;
...
//
short RPipeLine::Create(S32 lNum, short sW)
{
   if (sW)
   {
...
void RPipeLine::ClearClipBuffer()
{
   ...
   rspRect(U32(0), m_pimClipBuf, 0, 0,
...
void RPipeLine::ClearShadowBuffer()
{
   ...
   rspRect(U32(0), m_pimShadowBuf, 0, 0,
