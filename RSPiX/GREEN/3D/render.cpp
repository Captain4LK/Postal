...
//////////////////////////////////////////////////////////////////
   ...
   */
   ...
   S32 fx2 = pv2->x.val - fx1;
   S32 fx3 = pv3->x.val - fx1;
   S32 fz2 = pv2->z.val - fz1;
   S32 fz3 = pv3->z.val - fz1;
   ...
   if (y2)
   {
      ...
      fx2inc = U32(fx2.mod) * CInitNum::OneOver[y2]; // stuck with division using fx32!
      fz2inc = U32(fz2.mod) * CInitNum::OneOver[y2]; // stuck with division using fx32!
      */
   }

   S32 fx3inc = fx3 / y3; // stuck with division using fx32!
   S32 fz3inc = fz3 / y3; // stuck with division using fx32!
...
//////////////////////////////////////////////////////////////////
   ...
   if (y2 == 0) // p1.y == p2.y
   {
      ...
      for (y = y3; y; y--)
      {
         ...
         if (xdel) fzinc.val = S32(z2.mod - z1.mod) * RInitNum::OneOver[xdel];
   ...
   if (fx2inc <= fx3inc)
   {
      ...
      for (y = y2; y; y--)
      {
         ...
         xdel = x3.mod - x2.mod;
         //if (hzdel) hzinc.val = (z3.val - z2.val) / hzdel;
         if (xdel) fzinc.val = U32(z3.mod - z2.mod) * RInitNum::OneOver[xdel];
         //if (hzdel) Mul(hzinc,z3.val - z2.val,CInitNum::OneOver[hzdel]);
         // Assume 2 to 3:
      ...
      if (ybot)
      {
         ...
         /*
         fx2inc = U32(fx3.mod-fx2.mod) * CInitNum::OneOver[yc]; // stuck with division using fx32!
         fz2inc = U32(fz3.mod-fz2.mod) * CInitNum::OneOver[yc]; // stuck with division using fx32!
         */
         ...
         for (y = ybot; y; y--)
         {
            ...
            xdel = x3.mod - x2.mod;
            //if (hzdel) hzinc.val = (z3.val - z2.val) / hzdel;
            if (xdel) fzinc.val = S32(z3.mod - z2.mod) * RInitNum::OneOver[xdel];
            //if (hzdel) Mul(hzinc,z3.val - z2.val,CInitNum::OneOver[hzdel]);
...

   {
      ...
      for (y = y2; y; y--)
      {
         ...
         if (xdel) fzinc.val = S32(z2.mod - z3.mod) * RInitNum::OneOver[xdel];
      ...
      if (ybot)
      {
         ...
         */
         ...
         for (y = ybot; y; y--)
         {
            ...
            xdel = x2.mod - x3.mod;
            //if (hzdel) hzinc.val = (z2.val - z3.val) / hzdel;
            if (xdel) fzinc.val = U32(z2.mod - z3.mod) * RInitNum::OneOver[xdel];
            // Full accuracy fxMul!
            //if (hzdel) Mul(hzinc,z2.val - z3.val,CInitNum::OneOver[hzdel]);
            // Assume 2 to 3:
            for (x = x3.mod; x<= x2.mod; x++)
