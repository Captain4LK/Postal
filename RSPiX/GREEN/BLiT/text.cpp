...
U32   gulLassoBackgroundColor = 0;   // to ignore on Lasso
U32   gulCompressionBackgroundColor = 0;   // During compression
U32   gulConvertFromColor = 255; // reverting back...
UCHAR   gucAscii = (UCHAR) 0;
short gsTrimT = 0,gsMaxH = 0; // to further crop..
U32 gulDrawBack = 0, gulDrawFront = 1;

// Specify special conversion parameters...
//
void   rspSetConvertToFSPR1(U32 ulLassoBackCol,U32 ulComprBackCol,
...
// Specify special conversion parameters...
//
void   rspSetConvertFromFSPR1(U32 ulFrontCol,U32 ulBackCol)
   {
...
inline short   _ConvertToFSPR1(CImage* pImage,PIX choose)
   ...
   UCHAR*   pBuf = pImage->pData + sX + (S32)sY * pImage->lPitch;
   ...
   S32   lTrialSize = sH * 20; // Assum 20 bytes per line on average.
   S32   lActualSize = 0;
   ...
   pImage->lWidth = (S32)sW;
   pImage->lHeight = (S32)sH;
...
inline short _ConvertFromFSPR1(CImage* pImage,PIX choose)
   ...
   // Reset it all
   pImage->ulType = (U32)pHead->m_u32OldType; // Set back the type;
...
short   ConvertToFSPR1(CImage* pImage)
   ...
   switch(pImage->sDepth)
      ...
      case 32:
         //_ConvertToFSPR1(pImage,(U32)0); NOT YET!
      break;
...
//
short   rspBlit(U32 ulForeColor,U32 ulBackColor,CImage* pimSrc,CImage* pimDst,short sDstX,short sDstY,const Rect* prDst,
                 short sAddW)
   {
...
//
short   rspBlit(U32 ulForeColor,U32 ulBackColor,CImage* pimSrc,CImage* pimDst,
...
//
short   _rspBlit(U32 ulClrLTR,U32 ulClrBKD,CImage* pimSrc,CImage* pimDst,
...
void   instantiateBLIT()
   ...
   _rspBlit( (U32)0,(U32)0,pim,pim,(short)0,(short)0,(short)0,(short)0);
   }
