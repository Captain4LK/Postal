...
inline void _BLiTT(PIXSIZE ucTransparent, PIXSIZE* pSrc, PIXSIZE* pDst, S32 lSrcPitch, S32 lDstPitch,
...
//********************************************************************
   ...
   case 16:
      ...
      break;
   case 32:
      _BLiTT((U32 /*TODO was U32*/)ucTransparent, (U32*)pSrc, (U32*)pDst, (pimSrc->m_lPitch), (pimDst->m_lPitch), sH, short(sW >> 2));
      break;
   default:
