...
S32 m_lFadeInMillisecondsDuration;           // Original duration.
S32 m_lFadeInBytesDurationAffected;          // Amount left to fade.
S32 m_lFadeInBytesDuration;                  // Duration in bytes.

S32 m_lFadeInRate;

/////////////////////// Fade Out ////////////////////////////////////////

S32 m_lFadeOutMillisecondsDuration;             // Original duration.
S32 m_lFadeOutBytesDurationRemaining;           // Amount left to fade.
S32 m_lFadeOutBytesDuration;                    // Duration in bytes.
...
{
   S32 lMin;            // Mininum value (silence).
   S32 lMax;            // Maximum value (saturation).
} PCMINFO;

/////////////////////// Static members /////////////////////////////////

static S32 ms_lSamplesPerSec;          // Samples per second.
static S32 ms_lBitsPerSample;          // Bits per sample.
static S32 ms_lNumChannels;            // Number of channels.

static S32 ms_lBitsPerSec;          // Number of bits per second.
