...
static S32 ms_lSrcBitsPerSample;          // Sample size in bits for sample data.
                                          // 0 for no preference.
static S32 ms_lMixBitsPerSample;          // Sample size in bits for mixing.
static S32 ms_lDstBitsPerSample;          // Sample size in bits for Blue data.

static S32 ms_lNumChannels;            // Number of channels (mono
                                       //  or stereo).
