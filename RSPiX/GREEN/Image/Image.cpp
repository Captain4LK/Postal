...
short RImage::sCreateAlignedMem(void **hMem, void **hData, U32 ulSize)
{
   ...
   else
   {
      if (ulSize > 0)
      {
         ...
         if ((*hMem = aligned_alloc(16, ulSize + 15)) == NULL)
         {
         ...
         {
            memset(*hMem, 0, ulSize + 15);
            // Set Data buffer to 128-bit alignment
            // Captain4LK: I hate you, whoever wrote this, casting a pointer to an long instead of intptr, really?
...
short RImage::CreatePalette(U32 ulSize)
{
                                                            ...
                                                            if (sRes == 0)
                                                            {
                                                               if (pcf->Seek(lDibFileStartPos + dfh.ulOffBits, SEEK_SET) == 0)
                                                               {
                                                                  ...
                                                                  else
                                                                  {
                                                                     ...
                                                                     if (pcf->Read(m_pData, m_ulSize) != (S32)m_ulSize)
                                                                     {
...
short RImage::SaveDib(RFile* pcf)
{
   ...
   if (pcf && pcf->IsOpen())
   {
      S32 lDibPitch = WIDTHUCHAR((((S32)m_sWidth * (S32)m_sDepth + 7L) & ~7L) / 8L);
                                             ...
                                             if (pcf->Write(&dh.lYPelsPerMeter) == 1L)
                                             {
                                                if (pcf->Write(&dh.ulClrUsed) == 1L)
                                                {
                                                   if (pcf->Write(&dh.ulClrImportant) == 1L)
                                                   {
                                                      if (m_pPalette != NULL)
                                                      {
                                                         if (pcf->Write(m_pPalette->m_pData, m_pPalette->m_ulSize) == (S32)m_pPalette->m_ulSize)
                                                         {}
                                                         else
                                                         {
                                                      ...
                                                      if (sRes == 0)
                                                      {
                                                         ...
                                                         else
                                                         {
                                                            ...
                                                            if (pcf->Write(m_pData, m_ulSize) == (S32)m_ulSize)
                                                            {}
                                                            else
                                                            {
...
{
   short sReturn = SUCCESS;
   U32 ulFileType = IMAGE_COOKIE;
   U32 ulCurrentVersion = IMAGE_CURRENT_VERSION;
...
short RImage::WritePixelData(RFile* pcf) const
{
   ...
   if (m_sWidth <= m_sWinWidth && m_sHeight <= m_sWinHeight)
   {
      ...
      case 16:
         if (pcf->Write((U16*) m_pData, m_ulSize / 2) != (S32) m_ulSize / 2)
         {
      ...
      case 24:
         if (pcf->Write((RPixel24*) m_pData, m_ulSize / 3) != (S32) m_ulSize / 3)
         {
      ...
      case 32:
         if (pcf->Write((U32*) m_pData, m_ulSize / 4) != (S32) m_ulSize / 4)
         {
   ...
   else
   {
      ...
      if (m_sDepth < 8)
      {
         lBytesPerLine = (((S32)m_sWinWidth * lDepth) / 8);
         if ((((S32)m_sWinWidth * lDepth) % 8) > 0)
            lBytesPerLine++;
      }
      else
      {
...
short RImage::ReadPixelData(RFile* pcf)
{
   ...
   if (m_sWidth <= m_sWinWidth && m_sHeight <= m_sWinHeight)
   {
      ...
      case 16:
         if (pcf->Read((U16*) m_pData, m_ulSize / 2) != (S32) m_ulSize / 2)
         {
      ...
      case 24:
         if (pcf->Read((RPixel24*) m_pData, m_ulSize / 3) != (S32) m_ulSize / 3)
         {
      ...
      case 32:
         if (pcf->Read((U32*) m_pData, m_ulSize / 4) != (S32) m_ulSize / 4)
         {
