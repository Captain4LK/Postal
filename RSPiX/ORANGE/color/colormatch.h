...
extern   UCHAR rspMatchColorRGB(S32 r,S32 g,S32 b,short sStart,short sNum,
...
public:
   ...
   short CreateLightEffectRGB(UCHAR* pa,UCHAR* pr,UCHAR* pg,UCHAR* pb,S32 linc = 4,
...
public:
   ...
   static short QueryFastMultiAlpha(
      short sNumSrcCol, short sNumDstCol,S32 lTotMem, 
      S32* plHeaderSize = NULL,S32* plDataSize = NULL);
