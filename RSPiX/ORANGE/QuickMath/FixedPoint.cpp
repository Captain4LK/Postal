...
S32 RInitNum::OneOver[NUM_ONEOVER_FP32];
RInitNum::RInitNum()
{
   // Populate the oneOver array:
   OneOver[0] = S32(2147483647); // error, signed infinity!
   OneOver[1] = S32(65535); // full numbers!
   for (short i = 2; i<NUM_ONEOVER_FP32; i++) OneOver[i] = S32(65536) / i;
}
