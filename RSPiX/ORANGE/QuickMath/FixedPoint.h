...
inline void rspfpSet(&fpX,lVal) // lVal is an fpS32 in S32 form (mem)
...
typedef union
{
   S32 val;   //********* Full 32 bit signed value
   struct
   {
...
//====================
inline void rspfpSet(RFixedS32& s32fx, S32 lVal)
{ s32fx.val = lVal; }
...
inline void rspfpMul(RFixedS32 &lC, S32 lA, S32 lB)
{
   union
   {
      U32 val;
...
public:
RInitNum();
static S32 OneOver[NUM_ONEOVER_FP32];
};
...
inline S32 rspfpOneOver(short sDen) { return RInitNum::OneOver[sDen]; }
