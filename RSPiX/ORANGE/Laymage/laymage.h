...
// data.
short RLE_Decompress(char* pcBuffer, U32 ulCompSize, RFile* pcfRLE);
...
short ConvertToImage(short sLayer, U32 ulTop, U32 ulBottom, U32 ulLeft, U32 ulRight);
...
short AllocateChannelBuffers(U32 ulSize);
