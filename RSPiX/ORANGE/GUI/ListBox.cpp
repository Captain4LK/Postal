...
RListBox::RListBox()
{
   ...
   m_sbVert.m_ulUserInstance   = (uintptr_t)this;
   ...
   m_sbHorz.m_ulUserInstance   = (uintptr_t)this;
...
void RListBox::AdjustContents(void)             // Returns nothing.
{
   ...
   S32 lTotalHeight   = 0;    // Used for averaging heights.
   S32 lTotalItems    = 0;    // Used for averaging heights.
   ...
   RGuiItem*   pgui)                      // Item to encapsulate.
{
   ...
   if (pguiRes != NULL)
   {
      ...
      pguiRes->m_ulUserInstance   = (uintptr_t)this;
