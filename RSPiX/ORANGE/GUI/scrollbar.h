...
void GetRange(          // Returns nothing.
   S32* plMin,       // Out: Minimum position unless NULL.
   S32* plMax)       // Out: Maximum position unless NULL.
{
...
S32 m_lButtonIncDec;                // Amount to increment or decrement the
...
S32 m_lPosPerSecond;                // Number of positions smoothly scrolled
                                    // through in a second.  The rate of
                                    // smooth scrollage.

S32 m_lLastSmoothTime;                 // Last time smooth scroll was processed.

S32 m_lScrollToPos;                 // Position to smoothly scroll to.
...
S32 m_lMinPos;                         // Minimum value.
S32 m_lMaxPos;                         // Maximum value.
