...
// RString saves is the string's length as a S32 (32-bit) value.  We can
...
// written with a header that is well above 65K, so if the first S32 in an
...
virtual void CreateItems(
   S32 lNumItems)                                  // In:  Number of items
= 0;                                                  // Abstract function!
...
//
////////////////////////////////////////////////////////////////////////////////
virtual S32 NumItems(void)                                  // Returns total number of items
= 0;                                                  // Abstract function!
...
//
////////////////////////////////////////////////////////////////////////////////
virtual S32 TotalTime(void)                           // Returns total channel time
= 0;                                                  // Abstract function!
...
//
////////////////////////////////////////////////////////////////////////////////
virtual S32 Resolution(void)                          // Returns timing resolution
= 0;                                                  // Abstract function!
...
virtual void SetResolution(
   S32 lResolution)                                   // In:  New resolution
= 0;                                                  // Abstract function!
...
//
////////////////////////////////////////////////////////////////////////////////
S32 NumItems(void)                                    // Returns total number of items
{
   return -1;
}
...
//------------------------------------------------------------------------------
protected:
S32 m_lTotalTime;                                  // Total time
S32 m_lInterval;                                      // Time interval (ex: at 20 fps this would be 50)
S32 m_lNumItems;                                      // Number of data items
   ...
   short sFileVersion)                                // In:  Channel file version number
{
   ...
   if (sResult == 0)
   {
      ...
      if (!pFile->Error() && (m_lNumItems > 0))
      {
         ...
         for (S32 l = 0; (l < m_lNumItems) && (sResult == 0); l++)
...
S32 m_lTotalTime;                                  // Total time
S32 m_lInterval;                                      // Time interval (ex: at 20 fps this would be 50)
S32 m_lNumItems;                                      // Logical number of data items
S32 m_lRealNumItems;                               // Actual number of data items, which may be less
   ...
   RFile* pFile)                                      // In:  RFile to load from
{
   ...
   if (pFile->Read(&u32ID) == 1)
   {
      ...
      // was the string's length as a S32, we can use that to differentiate
...
//
////////////////////////////////////////////////////////////////////////////////
S32 TotalTime(void)                                   // Returns total channel time
{
...
//
////////////////////////////////////////////////////////////////////////////////
S32 Resolution(void)                               // Returns timing resolution
{
