...
RSprite::RSprite(RImage* pImage, U32 ulFlags)
{
   Init();
...
RSprite::RSprite(short sX, short sY, short sZ, short sAngle,
                 S32 lWidth, S32 lHeight, U32 ulFlags, RImage* pImage)
{
...
{
   short sReturn = SUCCESS;
   U32 ulFileType = SPRITE_COOKIE;
   U32 ulCurrentVersion = SPRITE_CURRENT_VERSION;
   U32 ulImageFlag = 0;
