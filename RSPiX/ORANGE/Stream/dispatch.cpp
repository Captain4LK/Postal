...
//
//////////////////////////////////////////////////////////////////////////////
void CDispatch::UseCall(UCHAR* pucBuffer, S32 lSize, USHORT usType,
...
//
//////////////////////////////////////////////////////////////////////////////
void CDispatch::UseCallStatic(UCHAR* pucBuffer, S32 lSize, USHORT usType,
                              UCHAR ucFlags, S32 lTime, S32 l_pDispatch)
{
...
//
//////////////////////////////////////////////////////////////////////////////
UCHAR* CDispatch::AllocCall(S32 lSize, USHORT usType, UCHAR ucFlags)
{
   UCHAR*   puc   = NULL;
...
//
//////////////////////////////////////////////////////////////////////////////
UCHAR* CDispatch::AllocCallStatic(   S32 lSize,
...
//
//////////////////////////////////////////////////////////////////////////////
short CDispatch::AddItem(   UCHAR* puc, S32 lSize, USHORT usType,
                            UCHAR ucFlags, S32 lTime)
{
...
//
//////////////////////////////////////////////////////////////////////////////
void CDispatch::BlowStatic(S32 l_pDispatch)
{
...
//
//////////////////////////////////////////////////////////////////////////////
void CDispatch::SetUserVal(USHORT usType, S32 lUser)
{
   ASSERT(usType < NUM_TYPES);
...
short CDispatch::Start(void)
{
   ...
   if (m_sActive == FALSE)
   {
      if (Blu_AddCritical((CRITICALL)BlowStatic, (S32)this) == 0)
      {
         // Success.
         m_sActive = TRUE;
      }
