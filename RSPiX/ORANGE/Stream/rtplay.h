...
// and parameters.
// Returns 0 on success.
short CreateCmd(USHORT usCmd, S32 lTime, S32 lParm1, S32 lParm2);
...
static void CriticalStatic(U32 ul_pRtPlay)
...
U32 m_ulChannelsDone;                  // Masks of channels that have
                                       // completed.

S32 m_lWindowSize;                     // Size for file window.
S32 m_lInputPaneSize;                  // Size for input pane of file window.
S32 m_lFilterPaneSize;                 // Size for filter pane of file window.
