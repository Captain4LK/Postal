                                      ...
                                      psndhdr->sNumChannels) == 0)
      {
         ...
         if (ms_listSndhdrs.Add(psndhdr) == 0)
         {
            ...
            if (sWasEmpty == TRUE)
            {
               ...
               if (Blu_AddCritical(CritiCall, (U32)this) == 0)
               {
                  // Success.
               }
               else
         ...
         if ((psndhdr->usStatus & STATUS_STARTED) == 0)
         {
            ...
            if (psb != NULL)
            {
               ...
               if (psb->lTime <= lTime)
               {
                  ...
                  if (psndhdr->mix.Start(MixCall, (U32)psndhdr, 0) == 0)
                  {
                     psndhdr->usStatus |= STATUS_STARTED;
                  }
                  else
...
void CRtSnd::SetDispatcher(CDispatch* pdispatch)
{
   ...
   if (m_pdispatch != NULL)
   {
      ...
      m_pdispatch->SetUserVal(RT_TYPE_SND, (S32)this);
   }
}
