...
// User callback.
typedef void (*FWFUNC)(PPANE ppane, S32 lUser);

typedef S32 (*FILEWIN_TIMEFUNC)(S32 lUserTime);
...
short SetSize(S32 lWinSize, S32 lIOPaneSize, S32 lUserPaneSize);

// Sets interval between input access.
void SetInputInterval(S32 lInputInterval)
...
void SetTimeFunc(FILEWIN_TIMEFUNC fnTime, S32 lTimeUser)
...
public:        // Members.
S32 m_lUser;                     // Set this to whatever you want!
