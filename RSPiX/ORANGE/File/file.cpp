...
//
//////////////////////////////////////////////////////////////////////////////
S32 RFile::Read(void* pData, S32 lNum)
{
...
//
//////////////////////////////////////////////////////////////////////////////
S32 RFile::Read(U16* pu16Data, S32 lNum /*= 1L*/)
{
   S32 lRes  = 0L;   // Assume success.
...
//
//////////////////////////////////////////////////////////////////////////////
S32 RFile::Read(S16* ps16Data, S32 lNum /*= 1L*/)
{
   S32 lRes  = 0L;   // Assume success.
...
//
//////////////////////////////////////////////////////////////////////////////
S32 RFile::Read(RPixel24* ppix24, S32 lNum /*= 1L*/)
{
   S32 lRes  = 0L;   // Assume success.
...
//
//////////////////////////////////////////////////////////////////////////////
S32 RFile::Read(U32* pu32Data, S32 lNum /*= 1L*/)
{
   S32 lRes  = 0L;   // Assume success.
...
//
//////////////////////////////////////////////////////////////////////////////
S32 RFile::Read(S32* ps32Data, S32 lNum /*= 1L*/)
{
   S32 lRes  = 0L;   // Assume success.
...
//
//////////////////////////////////////////////////////////////////////////////
S32 RFile::Read(S64* ps64Data, S32 lNum /*= 1L*/)
{
   S32 lRes  = 0L;   // Assume success.
...
//
//////////////////////////////////////////////////////////////////////////////
S32 RFile::Read(float* pfData, S32 lNum /*= 1L*/)
{
   S32 lRes  = 0L;   // Assume success.
...
//
//////////////////////////////////////////////////////////////////////////////
S32 RFile::Read(double* pdData, S32 lNum /*= 1L*/)
{
   S32 lRes  = 0L;   // Assume success.
...
//
//////////////////////////////////////////////////////////////////////////////
S32 RFile::Read(char* pszString)
{
   S32 lRes  = 0;    // Assume nothing.
...
//
//////////////////////////////////////////////////////////////////////////////
S32 RFile::Write(const void* pData, S32 lNum)
{
   S32 lRes  = 0;    // Assume success.
      ...
      if (IsMemory() == TRUE)
      {
         ...
         else
         {
            ...
            else
            {
               ...
               // overrun amount.
               S32 lCurPos        = m_pucCur - m_pucFile;
               S32 lDistanceToEOF = m_lSize - lCurPos;
...
//
//////////////////////////////////////////////////////////////////////////////
S32 RFile::Write(const U16* pu16Data, S32 lNum /*= 1L*/)
{
   S32 lRes  = 0L;   // Assume success.
...
//
//////////////////////////////////////////////////////////////////////////////
S32 RFile::Write(const S16* ps16Data, S32 lNum /*= 1L*/)
{
   S32 lRes  = 0L;   // Assume success.
...
//
//////////////////////////////////////////////////////////////////////////////
S32 RFile::Write(const RPixel24* ppix24, S32 lNum /*= 1L*/)
{
   S32 lRes  = 0;    // Assume success.
...
//
//////////////////////////////////////////////////////////////////////////////
S32 RFile::Write(const U32* pu32Data, S32 lNum /*= 1L*/)
{
   S32 lRes  = 0;    // Assume success.
...
//
//////////////////////////////////////////////////////////////////////////////
S32 RFile::Write(const S32* ps32Data, S32 lNum /*= 1L*/)
{
   S32 lRes  = 0;    // Assume success.
...
//
//////////////////////////////////////////////////////////////////////////////
S32 RFile::Write(const float* pfData, S32 lNum /*= 1L*/)
{
   S32 lRes  = 0;    // Assume success.
...
//
//////////////////////////////////////////////////////////////////////////////
S32 RFile::Write(const double* pdData, S32 lNum /*= 1L*/)
{
   S32 lRes  = 0;    // Assume success.
...
//
//////////////////////////////////////////////////////////////////////////////
S32 RFile::Write(const U64* pu64Data, S32 lNum /*= 1L*/)
{
   S32 lRes  = 0;    // Assume success.
...
//
//////////////////////////////////////////////////////////////////////////////
S32 RFile::Write(const S64* ps64Data, S32 lNum /*= 1L*/)
{
   S32 lRes  = 0;    // Assume success.
...
//
//////////////////////////////////////////////////////////////////////////////
S32 RFile::Write(const char* pszString)
{
   S32 lRes  = 0;    // Assume nothing.
...
//
//////////////////////////////////////////////////////////////////////////////
S32 RFile::Read24(   // Returns number of 24 bit items read.
   ...
   S32 lNum)            // In:  Number of 16 bit items to write.
{
   ...
   else
   {
      ...
      S32 lDst;                        // Number of items swapped on current
                                       // iteration.
      S32 lWritten = 0;                // Number of items written on current
                                       // iteration.
