...
S32 m_lBufSize;               // Size of buffer (0 means there is no buffer!)
S32 m_lStrLen;             // Length of string (up to but not including the terminating null)
...
void Construct(S32 lMinimumSize)
{
   m_pBuf = ms_pszEmpty;
   m_lBufSize = 0;
   m_lStrLen = 0;
...
////////////////////////////////////////////////////////////////////////////////
S32 Format(S32 lMinSize, char* format, ...);
...
// of this string.
////////////////////////////////////////////////////////////////////////////////
RString Mid(S32 lPos, S32 lLen) const;
...
////////////////////////////////////////////////////////////////////////////////
RString Range(S32 lPos1, S32 lPos2) const;
...
// maintain.
void Insert(S32 lPos, const RString& str);
void Insert(S32 lPos, const char* psz);
void Insert(S32 lPos, char c);

// These would be very cool variations, not very difficult to write, I just
// didn't have the time to spend right now.
      #if 0
void Insert(S32 lPos, const RString& str, S32 lLen);
void Insert(S32 lPos, const RString& str, S32 lPos, S32 lLen);
      #endif
...
// is, to reiterate, very clumsy.
      #if 0
void Insert(S32 lPos, short s);
void Insert(S32 lPos, unsigned short us);
void Insert(S32 lPos, S32 l);
void Insert(S32 lPos, U32 ul);
      #endif
...
RString(const char* rhs, S32 lMinimumSize = 0)
{
   Construct(lMinimumSize);
   operator=(rhs);
}
...
RString operator+(S32 rhs) const
{
   RString str = *this;
   str += rhs;
   return str;
...
RString operator+(U32 rhs) const
{
   RString str = *this;
   str += rhs;
   return str;
