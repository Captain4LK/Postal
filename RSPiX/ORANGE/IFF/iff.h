...
typedef struct
{
   ...
   U32 ulSize;             // Size of this chunk.
   S32 lDataPos;           // Position, in file, of data for this chunk.
   S32 lSizePos;           // Position, in file, of size for this chunk.  Used
                           // for writing chunks.
} CHUNK, *PCHUNK;
...
U32 GetChunk(void)            // Returns FCC of current chunk.
...
U32 GetForm(void)          // Returns FCC or 0 if no form for this chunk.
{ return m_chunk.fccForm; }

U32 GetSize(void)          // Returns size of current chunk.
...
static U32 IffStr2FCC(const char* pszFCC)
...
static U32 RiffStr2FCC(const char* pszFCC)
