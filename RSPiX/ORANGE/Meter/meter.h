...
// accurate results.
S32 SetNewValue(        // Returns previous value.
   S32 lNewVal)         // In: New value.
{
   S32 lRes  = m_lCurVal;
   // Store new val.
   m_lCurVal   = lNewVal;
...
S32 EndPeriod(void)        // Returns period.
{
...
S32 m_lCurVal;                                     // Value for next draw.
S32 m_lStartPeriod;                                // Start period.
...
S32 m_lDuration;                                   // Time between updates in
                                                   // milliseconds.
S32 m_lNextUpdate;                                 // Time of next update in
                                                   // milliseconds.
S32 m_lCurTotal;                                   // Current total.
S32 m_lNumValues;                                  // Number of values since
                                                   // total was last cleared.
S32 m_lMaxValue;                                   // Maximum value since
                                                   // total was last cleared.
