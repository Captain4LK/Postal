...
static S32 cur_buf_time = 0;
static S32 max_buf_time = 0;
...
extern short rspGetSoundOutMode(          // Returns 0 if successfull, non-zero otherwise
   ...
   S32* plBitsPerSample,            // Out: Bits per sample or -1 (unless NULL)
   S32* plChannels,              // Out: Channels (mono=1, stereo=2) or -1 (unless NULL)
   S32* plCurBufferTime,            // Out: Current buffer time or -1 (unless NULL)
   S32* plMaxBufferTime)         // Out: Maximum buffer time or -1 (unless NULL)
{
