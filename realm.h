...
S32 m_lScoreInitialTime;               // What timer was initially set to.
S32 m_lScoreTimeDisplay;               // Time in ms that is used for the Score display
                                       // (score converts it to minutes:seconds)
S32 m_lPrevTime;                       // Previous read of the clock
S32 m_lElapsedTime;
S32 m_lThisTime;


S32 m_lLastStatusDrawTime;             // Last time the status was drawn.
