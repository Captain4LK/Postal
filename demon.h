...
//---------------------------------------------------------------------------
public:
S32 m_lIdleTime;                          // Time without saying something
S32 m_lKillTimer;                      // Bonus kill timer
...
static S32 ms_lMinIdleTime;               // Min time before playing next sample
static S32 ms_lBonusKillTime;          // Kill an amount within this time and get a bonus comment
