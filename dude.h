...
S32 m_lNextBulletTime;                          // Next time a bullet can be fired.
S32 m_lLastShotTime;                            // Last time the dude was shot.
S32 m_lLastYellTime;                            // Last time the dude yelled in pain
                                                // from being shot or something.
S32 m_lNextIdleTime;                            // Idle animation timer.
...
short Load(                                           // Returns 0 if successfull, non-zero otherwise
   ...
   U32 ulFileVersion);                                // In:  File version being loaded.
...
void ProcessForces(                 // Returns nothing.
   S32 lCurTime,                    // In:  Current game time.
