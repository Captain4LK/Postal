...
////////////////////////////////////////////////////////////////////////////////
inline
S32 GetRandSway(     // Returns sway value.
   S32 lRange,       // In:  Total range of output value.
...
bool CCharacter::WhileBurning(void) // Returns true until state is complete.
{
   ...
   if (m_pRealm->m_idbank.GetThingByID((CThing**)&pfire, m_u16IdFire) == 0)
   {
      ...
      if (pfire->IsBurning() != FALSE)
      {
         ...
         S32 lTimeExpired   = MIN(lCurTime + BURN_DURATION - m_lCharacterTimer, (S32)BURN_DURATION);
