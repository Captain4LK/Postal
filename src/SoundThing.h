...
S32 m_lLastStartTime;
S32 m_lNextStartTime;
short m_sWhichTime;
bool m_bEnabled;
bool m_bRepeats;
...
S32 m_lLoopBackFrom;                      // Where to loop back from.
...
static S32 ms_lGetRandomSeed;             // Seed for get random.
...
// CSoundThing stuff.
static S32 GetRandom(void);
static S32 GetRand(void)
{
   return GetRandom();
}
