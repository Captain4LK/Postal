...
char g_pszOptionsMenu_Player[]               = "PLAYER";
...
char g_pszStartSinglePlayerMenu_New[]         = "NEW GAME";
   ...
   #endif
#endif
char g_pszStartSinglePlayerMenu_LoadLevel[]      = "LOAD LEVEL";
...
char g_pszMultiplayerSetupMenu_Color[]         = "COLOR";
...
const char* g_apszScoreGoalText[CRealm::TotalScoringModes] =
{
   ...
   "",                                                                           // MPLastManFrag
   "",                                                                           // MPLastManTimed
   " There are no time or kill limits on this game - play as S32 as you like" // MPLastManTimedFrag
...
const char* g_apszScoreGoalText[CRealm::TotalScoringModes] =
{
   ...
   "",                                                                           // MPLastManFrag
   "",                                                                           // MPLastManTimed
   " Aucune limite de temps ou de victimes dans ce jeu - jouez aussi S32temps que vous le souhaitez." // MPLastManTimedFrag
