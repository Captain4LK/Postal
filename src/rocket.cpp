...
S32 CRocket::ms_lArmingTime = 500;              // Time before weapon arms.
short CRocket::ms_sOffScreenDist = 200;            // Go off screen this far before blowing up
S32 CRocket::ms_lSmokeTrailInterval = 10;       // Time to emit smoke trail.
S32 CRocket::ms_lSmokeTimeToLive = 1000;           // Time for smoke to stick around.
