...
short CFirestream::Setup(                          // Returns 0 if successfull, non-zero otherwise
   ...
   S32 lTimeToLive,                             // In:  Number of milliseconds to burn, default 1sec
...
S32 CFireball::ms_lCollisionTime = 250;         // Check for collisions this often
...
//      m_sprite.m_sAlphaLevel = MIN((S32)255, (S32) (((m_lTimeToLive - m_pRealm->m_time.GetGameTime()) / m_lTotalFlameTime) * 255));
