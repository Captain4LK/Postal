...
S32 CGrenade::ms_lRandomAvoidTime = 200;           // Time to wander before looking again
S32 CGrenade::ms_lReseekTime = 1000;               // Do a 'find' again
S32 CGrenade::ms_lGrenadeFuseTime = 1500;       // Time from throw to blow
S32 CGrenade::ms_lSmokeInterval      = 100;         // Time between smokes.
