...
protected:
S32 m_lTimer;                          // General purpose timer
S32 m_lCollisionTimer;                 // Check for collisions when this expires
S32 m_lBurnUntil;                   // Burn until this time.
S32 m_lCurrentAlphaTimeout;            // Use current Alpha until this time, then switch
S32 m_lBrightAlphaInterval;            // Show each alpha for this amount of time
S32 m_lDimAlphaInterval;               // Show dim alpha level for this amount of time
S32 m_lTimeToLive;                     // Total time to show this animation
S32 m_lAlphaBreakPoint;             // Time to switch from Bright to Dim
S32 m_lStartTime;                   // Starting time used to calc the Alpha %
...
static S32 ms_lCollisionTime;          // Check for collisions this often
static S32 ms_lSmokeTime;           // Time to let smoke run
...
short Setup(                                          // Returns 0 on success.
   ...
   S32 lTimeToLive = 1000,                         // In: Milliseconds to burn
