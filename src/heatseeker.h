...
static S32 ms_lArmingTime;          // Time before weapons arms.
static S32 ms_lSeekRadius;          // Radius of Heatseeking circle
...
static S32 ms_lSmokeTrailInterval;        // Time between smoke releases
static S32 ms_lSmokeTimeToLive;           // Time for smoke to stick around.
