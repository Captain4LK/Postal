...
static S32 ms_lRandomAvoidTime;           // Time to wander before looking again
static S32 ms_lReseekTime;             // Time to wait before doing the next 'find'
static S32 ms_lWatchWaitTime;          // Watch your shot go
static S32 ms_lPatrolTime;             // Wait this S32 before shooting
static S32 ms_lDeathTimeout;              // Wait around after dying
static S32 ms_lBurningRunTime;            // Run this time before turning
static short ms_sHitLimit;                // Number of starting hit points
static short ms_sBurntBrightness;         // Brightness level when burnt
static S32 ms_lMaxShootTime;              // Maximum in ms of continuous shooting.
static S32 ms_lReselectDudeTime;       // Time before looking for a closer dude.
