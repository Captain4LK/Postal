...
static S32 ms_lFuseTime;                     // Timed mine explodes after this time
static S32 ms_lArmingTime;                // Proximity mines arm after this time
static S32 ms_lExplosionDelay;               // Delay before explosion triggers mine
...
short Setup(
   ...
   S32 lFuseTime);                                    // In: Time in ms for fuse
