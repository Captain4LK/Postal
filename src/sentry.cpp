...
S32 CSentry::ms_lRandomAvoidTime = 200;   // Time to wander before looking again
S32 CSentry::ms_lReseekTime = 1000;    // Do a 'find' again
S32 CSentry::ms_lWatchWaitTime = 2500;    // Time to watch shot go
S32 CSentry::ms_lPatrolTime = 5000;    // Time to patrol before shooting
S32 CSentry::ms_lDeathTimeout = 20000; // Wait around after dying
S32 CSentry::ms_lBurningRunTime = 50;     // Run this time before turning
         ...
         {
            {
               ...
               S32 lDist = RSP_SAFE_GUI_REF(peditRange, GetVal());
