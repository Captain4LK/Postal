...
S32 m_lNetMaxBlockingTime;                         // Maximum network blocking time
S32 m_lNetForceAbortTime;                          // Maximum time after which to force abort
/*** 12/5/97 AJC ***/
...
S32 m_lStartRealmTime;                             // Time when a client receives START_REALM from server
char m_bLogNetTime;                                // True, if user wants to log net time
/*** 12/5/97 AJC ***/
/*** 01/14/98 SPA ***/
S32 m_lPeerDropMaxWaitTime;                        // Maximum time to wait for peer data before
// dropping peer (in seconds!!)
/*** 01/14/98 SPA ***/

S32 m_lInitialDemoTimeOut;                         // Initial demo timeout.
S32 m_lPersistentDemoTimeOut;                      // Persistent demo timeout.
...
S32 m_alTitleDurations[MAX_TITLE_SCREENS];           // Time spent on title screen while "loading".
